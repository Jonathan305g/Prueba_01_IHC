...
| **8** | **Confirmación destructiva de cancelación** | Modal de alta visibilidad con advertencia explícita y confirmación en dos pasos para liberar el turno. | ![Cancelación Destructiva](capturas/imagen9.jpeg) |
